...
namespace APITest
{
    public partial class APITest : SmartContract
    {
        public static object StorageTest()
        {
            ...
            Runtime.Notify("aa", storageMap.Get(new byte[] { 0x01 }));
            ...
            Runtime.Notify("aa", Storage.Get(Storage.CurrentContext, "12315"));
            ...
            Runtime.Notify("aa", Storage.Get(Storage.CurrentContext, "12318"));
            ...
            Runtime.Notify("aa", Storage.Get(Storage.CurrentContext, "12317"));
        ...
        public static bool StorageContextTest(byte[] key, byte[] value)
        {
            ...
            Runtime.Notify("aa", Storage.Get(Storage.CurrentReadOnlyContext, "test"));

            StorageContext storageContext = Storage.CurrentContext.AsReadOnly;

            Runtime.Notify("aa", Storage.Get(storageContext, "test"));
            ...
            Runtime.Notify("aa", map);
            Runtime.Notify("aa", map.Keys.Length);
