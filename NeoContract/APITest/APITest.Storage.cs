...
namespace APITest
{
    public partial class APITest : SmartContract
    {
        public static object StorageTest()
        {
            ...
            OnNotify("aa", storageMap.Get(new byte[] { 0x01 }));
            ...
            OnNotify("aa", Storage.Get(Storage.CurrentContext, "12315"));
            ...
            OnNotify("aa", Storage.Get(Storage.CurrentContext, "12318"));
            ...
            OnNotify("aa", Storage.Get(Storage.CurrentContext, "12317"));
        ...
        public static bool StorageContextTest(byte[] key, byte[] value)
        {
            ...
            OnNotify("aa", Storage.Get(Storage.CurrentReadOnlyContext, "test"));

            StorageContext storageContext = Storage.CurrentContext.AsReadOnly;

            OnNotify("aa", Storage.Get(storageContext, "test"));
            ...
            {
                //Map<byte[], int> aa = new Map<byte[], int>();
                //Map<byte[], byte[]> map = (Map<byte[], byte[]>)whiteListBytes.Deserialize();
            }

            //map[key] = value;
            //whiteListMap.Put("whiteList", map.Serialize());
            //OnNotify("aa", map);
            //OnNotify("aa", map.Keys.Length);
